...
import 'package:meet_muslims_client/components/toast.dart';
                          ...
                          return Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "1. You'll receive an SMS with a unique OTP from us. 📱",
                                ...
                                Text(
                                  "2. Enter this OTP in the field displayed on your screen to proceed. This helps protect your account from unauthorized access. 🔒",
                                  style: Theme.of(context).textTheme.bodySmall,
                                ),
                                const SizedBox(
                                  height: 30,
                                ...
                                Text(
                                  "Didn't receive the OTP? No worries!",
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                                Text(
                                  "In case you haven't received the OTP, simply tap on 'Resend OTP' to get a new one. 🔄",
                                  style: Theme.of(context).textTheme.bodySmall,
                                ),
                                const SizedBox(
                                  height: 10,
                  ...
                  GestureDetector(
                    onTap: () {
                      requestOTP(userProvider.email).then((value) {
                        if (!value) {
                          appToast(context, "You have exceeded your max retries. Please try again later.", width);
                          return;
                        }
                        appToast(context, "A new OTP has been sent to your phone number.", width);
                      });
                    },
                    child: Text(
                      'Resend OTP',
